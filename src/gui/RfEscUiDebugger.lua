...
local function _getSoilModDirectory()
    ...
    if (FertilizerDepotModName or g_currentModName) == SOIL_MOD_NAME and (FertilizerDepotModDirectory or g_currentModDirectory) ~= nil then
        return (FertilizerDepotModDirectory or g_currentModDirectory)
    end
...
local function _getXmlPath()
    ...
    if (FertilizerDepotModDirectory or g_currentModDirectory) ~= nil then
        return (FertilizerDepotModDirectory or g_currentModDirectory) .. "xml/gui/" .. CLASS_NAME .. ".xml"
    end
    return nil
end
...
local function _getProfilesXml()
    ...
    return _profilesCandidate((FertilizerDepotModDirectory or g_currentModDirectory))
end
...
function RfEscUiDebugger.install()
    ...
    local soilDir = _getSoilModDirectory()
    local myDir = (FertilizerDepotModDirectory or g_currentModDirectory)
    ...
    local owner = ((FertilizerDepotModName or g_currentModName) ~= nil and (FertilizerDepotModName or g_currentModName)) or "unknown"
